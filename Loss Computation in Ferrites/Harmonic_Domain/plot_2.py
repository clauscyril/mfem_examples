...
plt.figure()
# plt.plot(f/1000,P_eddy/1000,label="Peddy FreeFem")
plt.plot(f_mfem/1000, P_eddy_mfem/1000, label="Peddy mfem")
# plt.plot(f/1000,P_exi/1000,label="Pexi FreeFem")
plt.plot(f_mfem/1000, P_exi_mfem/1000, label="Pexi mfem")
plt.xlabel("Frequency (kHz)")
plt.ylabel("Power (Kw/m^3)")
# plt.loglog()
plt.semilogx()
plt.grid()
plt.legend()
