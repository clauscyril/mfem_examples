...
int main() {
    ...
    // GridFunction pour afficher le terme source
    GridFunction q_grid(fespace);
    q_grid.ProjectCoefficient(q_function);
    ...
    for (int ti = 0; !done; )
    {
        ...
        q.Assemble();
        // q_grid.ProjectCoefficient(q_function); // Est utile uniquement si l'on souhaite afficher le terme source q
